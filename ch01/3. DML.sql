...
-- SELECT: 테이블에서 데이터를 조회할 때 사용하는 명령어alter
...
-- UPDATE 데이블명 SET 칼럼1 = 데이터1, ...;
-- UPDATE 데이블명 SET 칼럼1 = 데이터1, ...WHERE 조건;
...
-- DELETE FROM 테이블명; WHERE 조건; / 특정조건에 맞는 것만 삭제
DELETE FROM example_table; 
DELETE FROM example_table WHERE int_column = 50;


TRUNCATE TABLE example_table; -- 구조만 남기고 모두다 지운다.
