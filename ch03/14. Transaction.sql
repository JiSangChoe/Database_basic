...
-- 이메일을 email@email.com, 서버로 생성한 코드는 'OCMD'이다.
...
-- LIMIT 개수 : 결과테이블에서 지정한 갯수만큼의 상위 데이터만 보여줌
