...
-- 2. 이메일 인증 전송
INSERT INTO email_authentication VALUES ('email@eamil.com', 'QWER');

-- 3. 이메일 인증 확인
SELECT * FROM email_authentication 
WHERE email = 'email@eamil.com' AND authentication_code = 'QWER';

-- 4. 회원가입 처리
INSERT INTO user (user_id, password, email)
VALUES ('userID', 'P!ssw0rd', 'email@eamil.com');
...
VALUES ('질문있습니다.', '데이터는 언제 테이터인가요?', 'userID');

-- 7. 게시물 목록 보기
-- 제목, 작성자 아이디, 작성일, 조회수, 답변 내용을 조회
SELECT 
    reception_number, 
    reply_status, 
    title, 
